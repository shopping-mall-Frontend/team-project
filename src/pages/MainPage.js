          ...
          >
            <SwiperSlide>
              <Banner
                style={{
                  background:
                    'url("https://live.staticflickr.com/65535/51216932186_a89e171193_o.jpg") center center / cover no-repeat',
                }}
              ></Banner>
            </SwiperSlide>
            <SwiperSlide>
              <Banner
                style={{
                  background:
                    'url("http://the-edit.co.kr/wp-content/uploads/2021/02/1400_5_BOTTEGA-VENETA_FALL20-CAMPAIGN-5.jpg") center center / cover no-repeat',
                }}
              ></Banner>
            </SwiperSlide>
            <SwiperSlide>
              <Banner
                style={{
                  background:
                    'url("https://www.noblesse.com/shop/data/m/editor_new/2019/10/02/19e8151a86f3a75d0930_style_02.jpg") center center / cover no-repeat',
                }}
              ></Banner>
            </SwiperSlide>
          </Swiper>
