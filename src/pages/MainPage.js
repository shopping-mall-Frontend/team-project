    ...
    <>
      ...
      <Container>
        <BannerWrap>
          ...
          >
            <SwiperSlide>
              <Banner style={{ background:'url("/images/banner/gucci_banner.jpg") center center / cover no-repeat',}} />
            </SwiperSlide>
            <SwiperSlide>
              <Banner style={{ background:'url("/images/banner/louis_banner.jpg") center center / cover no-repeat',}} />
            </SwiperSlide>
            <SwiperSlide>
              <Banner style={{background:'url("images/banner/bottega_banner.jpg") center center / cover no-repeat',}} />
            </SwiperSlide>
            <SwiperSlide>
              <Banner style={{ background:'url("images/banner/chanel_banner.jpg") center center / cover no-repeat'}} />
            </SwiperSlide>
          </Swiper>
        </BannerWrap>
            ...
            <SwiperSlide>
              <div className='info-wrap' style={{ background:'url("/images/info_bg/gucci_info_bg.jpg") center center / cover no-repeat',}}>
                <p>
                  ...
                  다채로우면서도 현대적인 로맨티시즘이 반영되어 있는 구찌의 상품은 이탈리아의 장인 정신을 대표하며 정교한 디테일로 상품에 우수성을 더합니다.
                  <br/>
                  <br/>
                  구찌는 케어링 그룹 산하 브랜드입니다. 글로벌 럭셔리 그룹인 케어링은 패션, 가죽 제품, 주얼리 및 시계 분야의 여러 유명 하우스들을 관리하고 있습니다.
                </p>
            ...
            <SwiperSlide>
              <div className='info-wrap' style={{ background:'url("/images/info_bg/louis_info_bg.jpg") center center / cover no-repeat',}} >
                <p>
                  ...
                  기대되는 올해의 컨셉카에게 각각 '루이 비통 콩쿠르 어워드', '루이 비통 컨셉트 어워드'를 수여하고 있습니다.
                  루이비통은 산하에 루이비통 출판사를 두고 자체적인 브랜드 기획 도서를 발간하고 있으면, 세계적인 출판사들과 협력하여 미셀 투르니에, 마르셀 푸르스트, 
                  버지니아 울프 등 여러 유명 작가들의 여행기 뿐만 아니라 세계 100여 개 도시를 망라한 '시티 가이드 컬렉션',아티스트 컬래버 레이션 서적 등을 꾸준히 출판하고 있습니다.
                  <br/>
                  <br/>
                  이 처럼 루이비통은 단순한 제품 홍보가 아닌 브랜드 핵심가치에 부합하는 다양하고 확장적인 마케팅 활동을 전개함으로서 소비자에게 일관된 브랜드 아이덴티티를 전달합니다.
                </p>
                <Link to='/'>브랜드 바로가기</Link>
              </div>
            </SwiperSlide>
            ...
            <SwiperSlide>
              <div className='info-wrap' style={{ background:'url("/images/info_bg/chanel_info_bg.jpg") center center / cover no-repeat'}}>
                <p>
                  ...
                  시간을 초월해 많은 인기를 누리게 될 모던한 작품들을 탄생시켰습니다. 진주와 다이아몬드를 아이코닉 향수에 가볍게 매치한 시그니처 스타일 또한 빠트릴 수 없습니다. 
                  아방가르드한 여성이었던 가브리엘 샤넬은 자신의 라이프 스타일과 다양한 매력으로 샤넬 하우스의 가치를 형성한 선구자였으며, 오늘날까지 모든 여성들에게 풍부한 영감을 선사하고 있습니다.
                  <br/>
                  <br/>
